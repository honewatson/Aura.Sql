...
# eventually, create an Aura.Sql.Pdo git repo, and have this extract to
# ../Aura.Sql.Pdo, without directory modifications.
rm -rf Aura.Sql.Pdo
...
cp ./README-PDO.md          Aura.Sql.Pdo/README.md
